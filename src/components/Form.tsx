...
const Form: FC<IFormProps> = ({ fields, btnTitle, onSubmit, loading, btnClass, gridClass }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full p-2 sm:p-4">
            {/* Mobile: fields empilhados. Desktop: grid customizável */}
            <div className="flex flex-col gap-4 sm:grid sm:gap-6" style={{ gridTemplateColumns: gridClass || "repeat(2, minmax(0, 1fr))" }}>
